...
class AdManager(
    ...
    private fun loadTopBanner() {
        val adUnitId = if (BuildConfig.DEBUG) TEST_BANNER_AD_UNIT else PROD_BANNER_AD_UNIT
    ...
    private fun loadAndShowNativeAd() {
        ...
        val adUnitId = if (BuildConfig.DEBUG) TEST_NATIVE_AD_UNIT else PROD_NATIVE_AD_UNIT
