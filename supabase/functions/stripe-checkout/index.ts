...
Deno.serve(async (req) => {
  try {
    ...
    const { price_id, success_url, cancel_url, mode, user_id } = await req.json();

    const error = validateParameters(
      { price_id, success_url, cancel_url, mode, user_id },
      {
        cancel_url: 'string',
        price_id: 'string',
        success_url: 'string',
    ...
    // Verify user exists in our custom users table
